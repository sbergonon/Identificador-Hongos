...
// By storing only the path data, we create a more consistent and simpler SVG
// structure for rendering libraries like html2canvas to process, which can prevent
// data URL loading errors during canvas conversion.
const ICONS_PATHS: { [key:string]: React.ReactNode } = {
    camera: (
        <>
    ...
    mushroom: (
        <>
            <path strokeLinecap="round" strokeLinejoin="round" d="M20 11.15v-.15a8 8 0 1 0-16 0v.15" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 12v6" />
            <path strokeLinecap="round" strokeLinejoin="round" d="M12 22h0" />
