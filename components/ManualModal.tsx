...
const ManualContentEs: React.FC = () => (
  <>
    <h1 className="text-4xl font-extrabold text-stone-800 dark:text-amber-200 mb-4">Identificador de Hongos IA</h1>
    ...
    <h2 className="text-3xl font-bold text-stone-900 dark:text-amber-200 mt-8 mb-4 border-b border-gray-300 dark:border-slate-700 pb-2">Características Principales</h2>
    ...
    <h2 className="text-3xl font-bold text-stone-900 dark:text-amber-200 mt-8 mb-4 border-b border-gray-300 dark:border-slate-700 pb-2">Cómo Usar</h2>
    <ol className="list-decimal list-inside space-y-3 mb-6 text-lg">
      <li><strong className="font-semibold">Proporciona la Entrada</strong>: Toma una foto, sube una imagen o escribe el nombre del hongo que deseas identificar.</li>
       <div className="mt-4 p-4 bg-amber-50 dark:bg-stone-900/40 border border-amber-200 dark:border-stone-800 rounded-lg text-base">
          <h4 className="font-semibold text-lg text-amber-800 dark:text-amber-300 mb-2">Consejos para la Mejor Foto de Identificación</h4>
    ...
    <h2 className="text-3xl font-bold text-stone-900 dark:text-amber-200 mt-8 mb-4 border-b border-gray-300 dark:border-slate-700 pb-2">Descargo de Responsabilidad (¡MUY IMPORTANTE!)</h2>
...
const ManualContentEn: React.FC = () => (
    <>
        <h1 className="text-4xl font-extrabold text-stone-800 dark:text-amber-200 mb-4">AI Mushroom Identifier</h1>
        ...
        <h2 className="text-3xl font-bold text-stone-900 dark:text-amber-200 mt-8 mb-4 border-b border-gray-300 dark:border-slate-700 pb-2">Key Features</h2>
        <ul className="list-disc list-inside space-y-3 mb-6 text-lg">
        ...
        <h2 className="text-3xl font-bold text-stone-900 dark:text-amber-200 mt-8 mb-4 border-b border-gray-300 dark:border-slate-700 pb-2">How to Use</h2>
        <ol className="list-decimal list-inside space-y-3 mb-6 text-lg">
            <li><strong className="font-semibold">Provide Input</strong>: Take a photo, upload an image, or type the name of the mushroom you want to identify.</li>
             <div className="mt-4 p-4 bg-amber-50 dark:bg-stone-900/40 border border-amber-200 dark:border-stone-800 rounded-lg text-base">
                <h4 className="font-semibold text-lg text-amber-800 dark:text-amber-300 mb-2">Tips for the Best Identification Photo</h4>
                <ul className="list-disc list-inside space-y-1">
        ...
        <h2 className="text-3xl font-bold text-stone-900 dark:text-amber-200 mt-8 mb-4 border-b border-gray-300 dark:border-slate-700 pb-2">Disclaimer (VERY IMPORTANT!)</h2>
        <div className="p-4 bg-red-100 dark:bg-red-900/40 border-l-4 border-red-500 dark:border-red-600 text-red-800 dark:text-red-300 rounded-r-lg">
        ...
        <div className="fixed inset-0 bg-black/60 dark:bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={onClose}>
            <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col" onClick={(e) => e.stopPropagation()}>
                <div className="p-6 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center flex-shrink-0">
                    <h2 className="text-2xl font-bold text-stone-900 dark:text-amber-200">{t('appManual')}</h2>
